...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-gray-800">
      ...
      {/* Stats - Animated counters (repeat each time) */}
      <AboutStats />
      ...
      <section className="bg-slate-100 border-y border-slate-200">
        <div className="max-w-5xl mx-auto px-6 py-16 md:py-24">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {services.map((s, i) => (
              <ScrollReveal key={s.title} delay={i * 100} variant={i % 2 === 0 ? "left" : "right"}>
                <div className="flex gap-5 p-6 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {team.map((t, i) => (
            <ScrollReveal key={t.name} delay={i * 100} variant="up">
              <div className="text-center p-6 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition">
                <div
